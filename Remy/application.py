...
#8/27 開始寫加好友的Code refer to login and add_cash or register // 困難點:確認好友exit in user database and 把好友新增到 friend database
# 已經可以新增好友 判別重複，下一步要區分每隔ID 的好友是誰 現在資料庫整個混再一起  可以研究 session clear
